// import { GraphiQLPersistOptions, PersistentStorage, PersistedData } from "./types";

// export default class Storage<T> {
//   storage: PersistentStorage<PersistedData<T>>;
//   key: string;

//   constructor(options: GraphiQLPersistOptions<T>) {
//     const { storage, key = "graphiql-cache-persist" } = options;
